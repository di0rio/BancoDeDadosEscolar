...
namespace SGE.Controllers
{
    public class AlunosController : Controller
    {
        ...
        public async Task<IActionResult> AlterarFoto(Guid id, IFormFile novaFoto)
        {
            ...
            Guid idTipo = _context.TiposUsuario.Where(aluno => aluno.Tipo == "Aluno").FirstOrDefault().TipoUsuarioId; // Busca o id do tipo de usuário
            ViewData["TipoUsuarioId"] = idTipo; //Exibe o id do tipo do uuário na view
