...
namespace SGE.Controllers
{
	public class AlunosController : Controller
	{
		...
		public IActionResult Create()
		{
			...
			else                     //------------------------verifica se o usuario esta logado e seu limite de acesso-------------------------------
			{
				string Email = HttpContext.Session.GetString("email");
				var usuario = _context.Usuarios.Where(a => a.Email == Email).FirstOrDefault();
				Guid idTipoAluno = _context.TiposUsuario.Where(a => a.Tipo == "Aluno").FirstOrDefault().TipoUsuarioId;
		...
		public async Task<IActionResult> Create([Bind("AlunoId,Matricula,AlunoNome,Email,Celular,Logradouro,Numero,Cidade,Estado,CEP,Senha,DataNascimento,CadAtivo,DataCadastro,CadInativo, TipoUsuario,TipoUsuarioId,UrlFoto")] Aluno aluno, string ConfirmeSenha, IFormFile UrlFoto)
		{
